...
@SpringBootTest
public class IndividualClientFrequencyPropertiesTest {
    @Autowired
    private IndividualClientFrequencyProperties config;
    ...
    void InitializeWithCorrectDefaultProperties() {
        ...
        assertAll(
            ...
            () -> assertEquals(5, config.getMaxDepositsAccountHolder()),
            () -> assertEquals(3, config.getMaxTransfersSameBeneficiary()),
